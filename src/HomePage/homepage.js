...
const Homepage = () =>{
    ...
    return (
        <div class="whole">
            <div class="wbox">
                <h1 class="title">Welcome to CareWorx!</h1>
                <p>CAREWORX is an initiative that helps reconnect our elderly people with the community.</p>
                <p>Dive into our wide array of unique services which could help you participate in social activities,find your ideal aged-care home or interact with our</p>
                <p>virtual companion.Immerse yourself into the CareWorx experience!</p>
            </div>
